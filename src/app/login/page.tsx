          ...
          <header className="flex flex-col items-center mb-10 text-center">
            <div className="relative mb-6">
              ...
              <div className="relative p-5 rounded-full bg-zinc-900 border border-white/10 shadow-[inset_0_0_15px_rgba(34,197,94,0.1)]">
                <Image src="/caduceo.svg" height="55" width="55" alt="Logo" priority className="drop-shadow-[0_0_12px_rgba(34,197,94,0.6)]" />
              </div>
            </div>
              ...
              {!userNotFound ? (
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center gap-3 z-10">
                    ...
                    {!loading && <FiArrowRight size={14} className="text-green-500 group-hover:translate-x-1 transition-transform" />}
                  </span>
                </button>
              ) : (
                <button
